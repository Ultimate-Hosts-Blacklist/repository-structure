...
class Settings(object):  # pylint: disable=too-few-public-methods
    ...
    travis_autosave_final_commit = "[Results] Test of the testing system"
    # Default travis commit message
    travis_autosave_commit = "[Autosave] Test of the testing system"
    ...
    # Current directory.
    current_dir = '/home/travis/build/Ultimate-Hosts-Blacklist/repository-structure/'
